...
-   Theses authors were asked to provide their permission in writing for their thesis to be used in this project. Only theses for which permission was granted were included in the dataset.

### 2.2.2 Data processing

-   Full text data was extracted from PDF version of the theses using the PyMuPDF Python package. The full extracted text was anonymised and cleaned and it was stored in a `text_raw` column.
...
-   The front matter and back matter were removed, as they did not contain content relevant for text analysis.

## 2.3 Instrument- or software-specific information

-   Python 3.9:latest and PyMuPDF 1.21.0 were used for text extraction
-   R version 4.3.0 "Already Tomorrow" with RStudio version 2023.06.2+561 were used for data processing
...
-   "emu-metadata.csv": theses metadata
...
-   in tabular data, variable names use snake case; except for the ID, all variables are lower case
